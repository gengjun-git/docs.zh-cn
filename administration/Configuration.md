...
| thrift_client_timeout_ms             | 5000              | Thrift 客户端链接的idle时间，即链接超过该时间无新请求后则将链接断开。单位：ms。|
| thrift_server_queue_size             | 4096              | Thrift 服务器pending队列长度，如果当前处理线程超过了thrift_server_max_worker_threads，则进入队列|
